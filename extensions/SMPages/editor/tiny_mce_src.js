	...
	function selectControlElements() {
		editor.onClick.add(function(editor, e) {
			...
			if (/^(IMG|HR)$/.test(e.nodeName)) {
				try // Sitemagic CMS: Try/Catch added to fix image selection in Chrome58+: https://bugs.chromium.org/p/chromium/issues/detail?id=732123
				{
					selection.getSel().setBaseAndExtent(e, 0, e, 1);
				}
				catch(err) // Fails on Chrome 58+
				{
					selection.select(e);
				}
			}
